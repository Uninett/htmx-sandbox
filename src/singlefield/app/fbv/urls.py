...
singlefield = [
    ...
    path('<int:pk>/<str:fieldname>/', views.get_field_view2, name='fbv-book-edit-field'),
...
singlefield_htmx_get = [
    ...
    path('<int:pk>/<str:fieldname>/', views.get_field_view3, name='fbv-book-edit-field3'),
...
singlefield_htmx_boost = [
    ...
    path('<int:pk>/<str:fieldname>/', views.get_field_view4, name='fbv-book-edit-field4'),
