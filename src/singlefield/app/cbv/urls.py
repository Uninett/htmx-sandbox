...
singlefield = [
    ...
    path(
        '<int:pk>/delete/',
        views.SingleFieldDeleteBookView.as_view(),
        name='book-delete2',
    ),
    path(
        '<int:pk>/<str:fieldname>/',
        views.SingleFieldBookFieldView.as_view(),
        name='book-edit-field2',
    ),
    path(
        '<int:pk>/<str:fieldname>/update/',
        views.SingleFieldUpdateBookView.as_view(),
        name='book-edit2',
    ),
...
singlefield_htmx_get = [
    ...
    path(
        '<int:pk>/delete/',
        views.HTMxGetSingleFieldDeleteBookView.as_view(),
        name='book-delete3',
    ),
    path(
        '<int:pk>/<str:fieldname>/',
        views.HTMxGetSingleFieldBookFieldView.as_view(),
        name='book-edit-field3',
    ),
    path(
        '<int:pk>/<str:fieldname>/update/',
        views.HTMxGetSingleFieldUpdateBookView.as_view(),
        name='book-edit3',
    ),
...
singlefield_htmx_boost = [
    ...
    path(
        '<int:pk>/delete/',
        views.HTMxBoostSingleFieldDeleteBookView.as_view(),
        name='book-delete4',
    ),
    path(
        '<int:pk>/<str:fieldname>/',
        views.HTMxBoostSingleFieldBookFieldView.as_view(),
        name='book-edit-field4',
    ),
    path(
        '<int:pk>/<str:fieldname>/update/',
        views.HTMxBoostSingleFieldUpdateBookView.as_view(),
        name='book-edit4',
    ),
